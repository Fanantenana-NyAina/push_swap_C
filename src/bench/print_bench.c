...
/*   Updated: 2026/05/22 20:55:22 by tsirakot         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	total_ops(t_ops *n_ops)
{
	...
	total_r = n_ops->ra + n_ops->rb + n_ops->rr + n_ops->rra + n_ops->rrb
		+ n_ops->rrr;
...
void	print_bench(t_flag flag, double disorder, t_flag used_strategy,
		t_ops *n_ops)
{
